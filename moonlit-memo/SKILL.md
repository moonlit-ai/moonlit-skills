...
>
> ¹ Art. 82(1) Regulation (EU) 2016/679 (GDPR), OJ L 119, 4.5.2016, CELEX 32016R0679. [Source](https://eur-lex.europa.eu/eli/reg/2016/679/oj)
> *"Any person who has suffered material or non-material damage as a result of an infringement of this Regulation shall have the right to receive compensation from the controller or processor for the damage suffered."*
>
> ² CJEU 4 May 2023, C-300/21, ECLI:EU:C:2023:370 (UI v Österreichische Post AG), para 42. [Source](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:62021CJ0300)
...
7. Every source entry and every footnote link live in the rendered file, not plain text.
8. Zero em-dashes outside quoted passages.
9. No statement about the memo itself, its research, a platform, a tool or a sourcing standard anywhere in the document.
10. Footnotes contain only their notes; body text lives only in the body.
11. The whole document in the output language, impersonal voice.
12. The delivery message ready: summary, layers, one-word risk level, uncertainties, closing line; the closing line absent from the document.
